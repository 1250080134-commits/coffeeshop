...
export interface CartItem {
  cartKey: string; // unique: `${product.id}_${grindSize||''}_${selectedWeight||''}`
  product: Product;
  quantity: number;
  grindSize?: string;
  selectedWeight?: string;
  unitPrice: number; // actual price per unit (may differ from base if weight varies)
}
...
function makeCartKey(productId: string, grindSize?: string, selectedWeight?: string) {
